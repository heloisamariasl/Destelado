...
class Personagem:
    def __init__(self):
        ...
        self.no_chao = True          # NOVO: controla se está apoiado em algo
        self.velocidade_y = 0
        self.gravidade = 1
        self.chao_y = 460
        # ────────────────────────────────────────────────────────────────────────
        ...
        # rect inicial fixo (50x64) — será atualizado no atualizar()
    ...
    def atualizar(self):
        ...
        # chão padrão — o main.py pode sobrescrever chao_y antes de chamar atualizar
        ...
        # rect sempre com tamanho fixo de colisão (50x64)
        self.rect = pg.Rect(self.x_gato, self.y_gato, 50, 64)
    ...
    def barra_vida(self, janela):
        ...
        for i in range(self.vida_gato_max):
            ...
            janela.blit(imagem_redimensionada, (coracao, y))